...
class Logger
{
    ...
    /**
     * General-purpose log method to handle different log levels
     *
     * @param string $message Log message
     * @param string $level Log level (error, warning, notice, unknown)
     */
    public function log(string $message, string $level = 'error'): void
    {
        switch (strtolower($level)) {
            case 'notice':
                $this->noticeHandler($message);
                break;
            case 'warning':
            ...
            case 'unknown':
            default:
                $this->unknownErrorHandler($message);
                break;
        }
    }
